...
RUN cp /etc/apache2/conf-available/php5-fpm.conf /etc/apache2/conf-available/php5-fpm.conf.bak
COPY ./conf/apache2/conf-available/php5-fpm.conf /etc/apache2/conf-available/php5-fpm.conf
RUN cp /etc/apache2/sites-available /etc/apache2/sites-available.bak
