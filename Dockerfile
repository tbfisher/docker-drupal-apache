...
# Configure PHP
RUN mkdir /run/php
RUN cp /etc/php/5.5/fpm/php.ini /etc/php/5.5/fpm/php.ini.bak
COPY ./conf/php/fpm/php.ini-development /etc/php/5.5/fpm/php.ini
# COPY /conf/php/fpm/php.ini-production /etc/php/5.5/fpm/php.ini
